...
/obj/machinery/kaos/cargo_machine/red
	...
	products = list(
		...
		list("name" = "Fancy Food Pack", "price" = 50, "category" = "Miscellaneous", "path" = /obj/structure/closet/crate/scuffedcargo, "willcontain" = list(/obj/item/reagent_containers/food/snacks/plainburger = 5, /obj/item/reagent_containers/food/drinks/bottle/specialwhiskey = 1)),
